...
export default function SnackBoxContent() {
  return (
    <>
      <HeroSnack />
      <main className="bg-gradient-to-b from-[#141e14] to-[#1C2C1C] text-slate-100 py-10">
              ...
              <div className="p-8 max-w-xl">
                ...
                <div className="flex justify-center space-x-4 mb-6">
                  <div className="flex flex-row justify-center items-center space-x-4">
                    <Link
                      href="https://drive.google.com/file/d/1EC1arSVi6Oh03oM-0gSi_OCo7mhO9LUt/view?usp=sharing"
        ...
        <CTASection
          ...
          primaryCTA={{
            ...
            target: "_blank",
            rel: "noopener noreferrer",
            gtmValue: "PESAN CATERING Snack & Coffee Break Premium",
          }}
        />
      </main>
    </>
