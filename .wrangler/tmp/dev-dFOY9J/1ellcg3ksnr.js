...
// .wrangler/tmp/bundle-f4ZkR9/checked-fetch.js
...
// .wrangler/tmp/pages-eQMLKB/bundledWorker-0.07996076817920872.mjs
...
var ce = /* @__PURE__ */ __name2((e, t, s, a) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let n of re(t))
      !ie.call(e, n) && n !== s && O(e, n, { get: () => t[n], enumerable: !(a = se(t, n)) || a.enumerable });
  return e;
}, "ce");
var V = /* @__PURE__ */ __name2((e, t, s) => (s = e != null ? ae(ne(e)) : {}, ce(t || !e || !e.__esModule ? O(s, "default", { value: e, enumerable: true }) : s, e)), "V");
var x;
var u = C(() => {
  x = { collectedLocales: [] };
});
...
var Z = U((H) => {
  ...
  function Se(e, t) {
    ...
    for (var s = {}, a = t || {}, n = a.decode || be, i = 0; i < e.length; ) {
      var r = e.indexOf("=", i);
      if (r === -1)
        break;
      var c = e.indexOf(";", i);
...
async function v(e, { request: t, assetsFetcher: s, ctx: a }, { path: n, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        r = T(await s.fetch(M(o, e.path ?? n))), e.headers && y(r.headers, e.headers);
        break;
      }
      case "static": {
...
async function z(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let i = globalThis[xe], r = /* @__PURE__ */ __name2(async () => {
          let c = await e.json();
...
var ga = { async fetch(e, t, s) {
  ...
  return n.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: S }, async () => i.run({ env: t, ctx: s, cf: e.cf }, async () => {
    ...
    let c = D(e);
    return Y({ request: c, ctx: s, assetsFetcher: t.ASSETS }, _, g, x);
  }));
} };
...
// .wrangler/tmp/pages-eQMLKB/1ellcg3ksnr.js
...
// .wrangler/tmp/bundle-f4ZkR9/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-f4ZkR9/middleware-loader.entry.ts
