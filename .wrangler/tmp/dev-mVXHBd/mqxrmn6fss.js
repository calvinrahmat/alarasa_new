...
// .wrangler/tmp/bundle-f0k5Qa/checked-fetch.js
...
// .wrangler/tmp/pages-9wXf3F/bundledWorker-0.38720625575722734.mjs
...
var F = /* @__PURE__ */ __name2((e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), "F");
...
var O = /* @__PURE__ */ __name2((e, t, s) => (s = e != null ? ae(ne(e)) : {}, ce(t || !e || !e.__esModule ? H(s, "default", { value: e, enumerable: true }) : s, e)), "O");
var x;
var u = C(() => {
  x = { collectedLocales: [] };
});
...
__name(k, "k");
__name2(k, "k");
function E(e, { url: t, cookies: s, headers: a, routeDest: n }) {
  switch (e.type) {
    case "host":
      return { valid: t.hostname === e.value };
    case "header":
      return e.value !== void 0 ? A(e.value, a.get(e.key), n) : { valid: a.has(e.key) };
    case "cookie": {
      let i = s[e.key];
...
var w = /* @__PURE__ */ __name2(class {
  ...
  checkRouteMatch(t, { checkStatus: s, checkIntercept: a }) {
    ...
    }) && !t.missing?.find((r) => E(r, i).valid) && !(s && t.status !== this.status)) {
      if (a && t.dest) {
  ...
  applyLocaleRedirects(t) {
    if (!t.locale?.redirect || !/^\^(.)*$/.test(t.src) && t.src !== this.path || this.headers.normal.has("location"))
      return;
    let { locale: { redirect: a, cookie: n } } = t, i = n && this.cookies[n], r = L(i ?? ""), c = L(this.reqCtx.request.headers.get("accept-language") ?? ""), d = [...r, ...c].map((f) => a[f]).filter(Boolean)[0];
    if (d) {
  ...
  async checkPhase(t) {
    ...
    let n = "miss";
    return a || t === "miss" || t === "error" ? n = "hit" : s && (n = I(t)), this.checkPhase(n);
  }
  async run(t = "none") {
...
function Ce() {
  ...
  return new Proxy(globalThis, { get: (t, s) => e.has(s) ? e.get(s) : Reflect.get(globalThis, s), set: (t, s, a) => Ae.has(s) ? Reflect.set(globalThis, s, a) : (e.set(s, a), true) });
}
__name(Ce, "Ce");
__name2(Ce, "Ce");
...
// .wrangler/tmp/pages-9wXf3F/mqxrmn6fss.js
...
// .wrangler/tmp/bundle-f0k5Qa/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-f0k5Qa/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=mqxrmn6fss.js.map
